##Transpotition Cipher Hacker by Mansoor Nabwi
## https://github.com/Mansoorinho/simple_programs (BSD Licensed)
# February 22 2020

import pyperclip, detecEnglish, TranspostionCipher_Decryption
...
def hackTransposition(message):
    ...
    for key in range(1, len(message)):
        ...
        decryptedText = TranspostionCipher_Decryption.decryptMessage(key,message)

        if detecEnglish.isEnglish(decryptedText):
